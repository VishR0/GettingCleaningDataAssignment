...
The data set that this code book explains is the `tidy_data.txt` file in this repository.

See the `README.md` file before going further.

The structure of the data set is described in the [Data](#data) section, its variables are described in the [Variables](#variables) section, and the transformations and manipulations applied on the source data are described in the [Transformations](#transformations) section.

## Data <a name="data"></a>

The `tidy_data.txt` data file is a containing space-separated values text file.
